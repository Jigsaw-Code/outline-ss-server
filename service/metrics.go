...
var _ TCPConnMetrics = (*tcpConnMetrics)(nil)
...
var _ ShadowsocksConnMetrics = (*tcpServiceMetrics)(nil)
...
var _ UDPConnMetrics = (*udpConnMetrics)(nil)
...
type serviceMetrics struct {
	...
	// NOTE: New metrics need to be added to `NewPrometheusServiceMetrics()`, `Describe()` and `Collect()`.
	// TODO: Add time to first byte.
}

var _ prometheus.Collector = (*serviceMetrics)(nil)
var _ ServiceMetrics = (*serviceMetrics)(nil)

// NewPrometheusServiceMetrics constructs a Prometheus metrics collector that uses
// `ip2info` to convert IP addresses to countries. `ip2info` may be nil.
func NewPrometheusServiceMetrics(ip2info ipinfo.IPInfoMap) (*serviceMetrics, error) {
...
func (m *serviceMetrics) AddOpenTCPConnection(clientConn net.Conn) TCPConnMetrics {
	clientAddr := clientConn.RemoteAddr()
...
func (m *serviceMetrics) AddUDPNatEntry(clientAddr net.Addr, accessKey string) UDPConnMetrics {
	clientInfo := m.getIPInfoFromAddr(clientAddr)
