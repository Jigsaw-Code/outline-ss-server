...
// // Example usage in TestConfigValidate
// // ... (rest of the test cases) ...
// 		{
// 			name: "invalidListenerTCPListenerWithInvalidAddress",
// 			cfg: &Config{
...
// 				},
// 			},
// 			errStr: fmt.Errorf("invalid listener address ':invalid': %w", &net.AddrError{Err: "missing port in address", Addr: ":invalid"}).Error(),
// 		},
// // ... (rest of the test cases) ...
